...
document.querySelector("#refresh").addEventListener("click",()=>refresh(true));document.querySelector("#clear-all").addEventListener("click",clearAll);document.querySelector("#detail-refresh").addEventListener("click",()=>selectedId&&openDetail(selectedId));document.querySelector("#close-detail").addEventListener("click",closeDetail);document.querySelector("#detail-dialog").addEventListener("close",()=>{selectedId=null;selectedSnapshot=null});document.querySelector("#delete-work").addEventListener("click",deleteWork);
