...
export function validateConfig(config) {
  ...
  if (!Number.isInteger(config.team.max_workers) || config.team.max_workers < 1 || config.team.max_workers > 3) {
    throw new Error("team.max_workers must be an integer from 1 to 3");
  }
  return config;
}
